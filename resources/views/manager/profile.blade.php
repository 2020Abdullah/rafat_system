                    ...
                    <div class="jumbotron glass profile">
                      <div class="card-body">
                        <div class="profile_img">
                            <img src="{{ asset('/storage/images/'. auth('manager')->user()->profile_img) }}" alt="logo">
                        </div>
                                ...
                                <div>
                                    <form method="POST" action="{{ route('manager.profile.update') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{ auth('manager')->user()->name }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">بريدك الإلكتروني</label>
                                            <input type="text" class="form-control" name="email" value="{{ auth('manager')->user()->email }}">
                                        </div>
                                        <div class="mb-3">
